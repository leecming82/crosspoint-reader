  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Toggle(StrId::STR_HYPHENATION, &CrossPointSettings::hyphenationEnabled, "hyphenationEnabled",
                            StrId::STR_CAT_READER),
        SettingInfo::Enum(
            StrId::STR_READING_LAYOUT, &CrossPointSettings::readingLayout,
            {StrId::STR_READING_LAYOUT_AUTO, StrId::STR_READING_LAYOUT_HORIZONTAL_PORTRAIT,
             StrId::STR_READING_LAYOUT_HORIZONTAL_LANDSCAPE_CW, StrId::STR_READING_LAYOUT_HORIZONTAL_INVERTED,
             StrId::STR_READING_LAYOUT_HORIZONTAL_LANDSCAPE_CCW, StrId::STR_READING_LAYOUT_VERTICAL_RL},
