...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_READING_LAYOUT, &CrossPointSettings::writingModePreference,
                          {StrId::STR_BOOK_S_STYLE, StrId::STR_READING_LAYOUT_HORIZONTAL_PORTRAIT,
                           StrId::STR_READING_LAYOUT_VERTICAL_RL},
                          "writingModePreference", StrId::STR_CAT_READER),
