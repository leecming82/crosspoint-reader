...
class GfxRenderer {
 ...
 public:
  ...
  uint32_t getVerticalSubstitution(int fontId, uint32_t cp, EpdFontFamily::Style style = EpdFontFamily::REGULAR) const;
  ...
  void drawTextVertical(int fontId, int x, int y, const char* text, bool black = true,
                        EpdFontFamily::Style style = EpdFontFamily::REGULAR, int charSpacing = 2) const;
  ...
  void drawTextTateChuYoko(int fontId, int x, int y, const char* text, bool black = true,
                           EpdFontFamily::Style style = EpdFontFamily::REGULAR, int columnWidth = 0) const;
